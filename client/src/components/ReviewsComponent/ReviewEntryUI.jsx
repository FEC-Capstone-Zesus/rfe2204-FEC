...
const ReviewEntryUI = ({ review, date, helpful, report, handleReportClick, handleHelpfulClick }) => {
  return (
    <ReviewEntryContainer>
      ...
      <ReviewContent>
        <ContentContainer>{review.body}</ContentContainer>
        {review.recommend ? <RecommendContainer>&#x2713; I recommend this product</RecommendContainer> : null}
        {review.photos ? <PhotoContainer> <Photo photos={review.photos} /> </PhotoContainer> : null}
        {review.response ? <ResponseContainer> Response:&nbsp;{review.response} </ResponseContainer> : null}
      </ReviewContent>
