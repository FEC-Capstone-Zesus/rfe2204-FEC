...
const FilterButtonContainer = ({filter, handleClear}) => {
  return (
    <>
      <ButtonContainer>
        {filter['5'] ? <FilterButton>5-stars</FilterButton> : null}
        {filter['4'] ? <FilterButton>4-stars</FilterButton> : null}
        {filter['3'] ? <FilterButton>3-stars</FilterButton> : null}
        {filter['2'] ? <FilterButton>2-stars</FilterButton> : null}
        {filter['1'] ? <FilterButton>1-stars</FilterButton> : null}
      </ButtonContainer>
